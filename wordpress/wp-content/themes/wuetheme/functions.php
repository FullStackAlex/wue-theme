...
function enqueue_footer_scripts() {
	...
	//append last edit timestamp to production bundles to be able to load latest versions of the file if http caching is enabled (as we have disabled webpack hashing to be able to know which files we have to enqueue):
...
function initial_loader() {
	get_template_part( "partials/initial-loader" );
}
